          ...
          if (categoryController.isAllCategoryLoading.value) {
            ...
            return GridView.builder(
                gridDelegate:  SliverGridDelegateWithMaxCrossAxisExtent(
                    childAspectRatio: MediaQuery.textScaleFactorOf(context)*.90,
                    mainAxisSpacing: 9.0,
                ...
                itemBuilder: (context, index) {
                  return buildCardItems(
                      image: categoryController.categoryList[index].imgUrl!,
                      price: categoryController.categoryList[index].price!,
                      rate: categoryController.categoryList[index].rate!,
