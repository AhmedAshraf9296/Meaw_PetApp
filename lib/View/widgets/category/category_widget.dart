...
import 'package:meaw/View/widgets/category/category_items.dart';
            ...
            itemBuilder: (context, index) {
              return InkWell(
                onTap: () {
                  ...
                  Get.to(() => CategoryItems(categoryTitle: controller.categoryNameList[index].name,));
                },
                child: Container(
                  height: 150,
                  ...
                  child:  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        controller.categoryNameList[index].name,
